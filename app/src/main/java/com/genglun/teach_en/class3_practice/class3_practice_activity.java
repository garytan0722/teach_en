 ...
 */
public class class3_practice_activity extends AppCompatActivity{
    String t1,t2,t3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.class3_practice);
    ...
    private void initTabFragment(Bundle savedInstanceState){
        if (savedInstanceState == null) {
            class3_practice_tab tabFragment = new class3_practice_tab();
