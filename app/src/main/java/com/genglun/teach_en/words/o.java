 ...
 */
public class o extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton o_voice = (FloatingActionButton) findViewById(R.id.voice);
        o_voice.setOnClickListener(this);
