 ...
 */
public class w extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton w_voice = (FloatingActionButton) findViewById(R.id.voice);
        w_voice.setOnClickListener(this);
