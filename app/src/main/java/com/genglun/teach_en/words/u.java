 ...
 */
public class u extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton u_voice = (FloatingActionButton) findViewById(R.id.voice);
        u_voice.setOnClickListener(this);
