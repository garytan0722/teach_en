 ...
 */
public class k extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton k_voice = (FloatingActionButton) findViewById(R.id.voice);
        k_voice.setOnClickListener(this);
