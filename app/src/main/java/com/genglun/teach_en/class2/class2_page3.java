 ...
 */
public class class2_page3 extends BaseFragment implements View.OnClickListener {

    private static final String TAG = "class2_page3";
    private MediaPlayer mp;

    public static class2_page3 newInstance() {
        Log.d(TAG, "newInstance");
        class2_page3 f = new class2_page3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.class2_page3, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        TextView surf = (TextView) view.findViewById(R.id.surf);
        Spannable word = new SpannableString("Surf");
