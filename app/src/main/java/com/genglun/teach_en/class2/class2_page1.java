 ...
 */
public class class2_page1 extends BaseFragment implements View.OnClickListener {

    private static final String TAG="class2_page1";
    private MediaPlayer mp;
    public static class2_page1 newInstance() {
        Log.d(TAG, "newInstance");
        class2_page1 f = new class2_page1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.class2_page1, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        TextView fiy=(TextView) view.findViewById(R.id.flying);
        Spannable word = new SpannableString("Fly");
