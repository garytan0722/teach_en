 ...
 */
public class class1_tab extends Fragment {
    ...
    public static Fragment newInstance(){
        class1_tab f = new class1_tab();
        return f;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.class1_tab, container, false);
    }
...
//        tabs.setViewPager(pager);
    ...
    private LinkedList<BaseFragment> getFragments(){
        ...
        int dividerColor = Color.parseColor("#000000");;
        LinkedList<BaseFragment> fragments = new LinkedList<BaseFragment>();

        fragments.add(class1_page1.newInstance());
        fragments.add(class1_page2.newInstance());
        fragments.add(class1_page3.newInstance());
        fragments.add(class1_page4.newInstance());
        fragments.add(class1_page5.newInstance());
        fragments.add(class1_page6.newInstance());
        return fragments;
    }
