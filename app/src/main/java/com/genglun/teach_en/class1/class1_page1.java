 ...
 */
public class class1_page1 extends BaseFragment implements View.OnClickListener {

    private static final String TAG="class1_page1";
    private MediaPlayer mp;
    public static class1_page1 newInstance() {
        Log.d(TAG, "newInstance");
        class1_page1 f = new class1_page1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.class1_page1, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        TextView eating=(TextView) view.findViewById(R.id.eatbreakfast);
        Spannable word = new SpannableString("Eat");
