 ...
 */
public class class1_page4 extends BaseFragment implements View.OnClickListener {

    private static final String TAG="class1_page4";
    private MediaPlayer mp;
    public static class1_page4 newInstance() {
        Log.d(TAG, "newInstance");
        class1_page4 f = new class1_page4();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.class1_page4, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        TextView eating=(TextView) view.findViewById(R.id.study);
        Spannable word = new SpannableString("Study");
