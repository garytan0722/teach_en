 ...
 */
public class class1_page3 extends BaseFragment implements View.OnClickListener {

    private static final String TAG = "class1_page3";
    private MediaPlayer mp;

    public static class1_page3 newInstance() {
        Log.d(TAG, "newInstance");
        class1_page3 f = new class1_page3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.class1_page3, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        TextView eating = (TextView) view.findViewById(R.id.eatdinner);
