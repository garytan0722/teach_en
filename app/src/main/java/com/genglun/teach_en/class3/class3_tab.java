 ...
 */
public class class3_tab extends Fragment {
    ...
    public static Fragment newInstance(){
        class3_tab f = new class3_tab();
        return f;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.class3_tab, container, false);
    }
...
//        tabs.setViewPager(pager);
    ...
    private LinkedList<BaseFragment> getFragments(){
        ...
        fragments.add(class3_page1.newInstance());
        fragments.add(class3_page2.newInstance());
        fragments.add(class3_page3.newInstance());
        fragments.add(class3_page4.newInstance());
        fragments.add(class3_page5.newInstance());
        fragments.add(class3_page6.newInstance());
        fragments.add(class3_page7.newInstance());
        fragments.add(class3_page8.newInstance());
        return fragments;
    }
