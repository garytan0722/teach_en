 ...
 */
public class class3_page5 extends BaseFragment implements View.OnClickListener {

    private static final String TAG="class3page5";
    private MediaPlayer mp;
    public static class3_page5 newInstance() {
        Log.d(TAG, "newInstance");
        class3_page5 f = new class3_page5();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.class3_page5, container, false);
    }
